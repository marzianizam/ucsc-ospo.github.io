...
- **Bias detection:** High-prestige professions (e.g., doctors, CEOs) showed >68% light-skinned outputs, while low-status roles skewed heavily toward darker tones:contentReference[oaicite:3]{index=3}.  
...
- **Generalization:** The method extends naturally to **gender and age balancing**, enabling intersectional fairness without retraining:contentReference[oaicite:4]{index=4}.  
...
- 📑 [Full Paper](https://drive.google.com/file/d/16x8ZAHhNWPFg-8SOTGp7TJhLFxohxFTq/view?usp=sharing)  
- 📂 [Supplementary Material](https://drive.google.com/file/d/18e0wd-TjV65j5kEQJLWeASsbvQ0xFptX/view?usp=sharing)  
